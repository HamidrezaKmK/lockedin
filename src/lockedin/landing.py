...
DEFAULT_LANDING: dict[str, Any] = {
    ...
    "why": {
        ...
        "text": "A good student does not send you a wall of text — they take you to the board, and you interrupt at the step that does not hold. lockedin is that arrangement, built for an agent.",
        "bullets": [],
    },
    "workflow": {
        "title": "How a week actually goes",
        "intro": "The loop you repeat while an idea is being worked out.",
        "steps": [
            {"number": "01", "title": "You set the question", "text": "One paragraph on what you are trying to establish."},
            {"number": "02", "title": "It goes and works", "text": "Experiments, figures, derivations — kept in the bubble, not in a scrollback."},
            {"number": "03", "title": "It presents", "text": "A short deck with the soft spots named, when it needs your judgement."},
            {"number": "04", "title": "You mark up", "text": "It re-derives, argues back, and the history keeps your objection."},
        ],
    },
    "components": {
    ...
    "pi": {
        ...
        "text": "lockedin is an interface, not a model wrapper. Bring the subscription you already pay for, or a local model.",
        "bullets": [
            "Claude, Codex, Gemini, GPT — or Qwen on your own GPU.",
    ...
    "scientist": {
        ...
        "intro": "The 🤖 button on any bubble hands you a single command to paste. The steps below are only for doing it by hand.",
        "platforms": [
