...
<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234dd9b8' stroke-width='1.8' stroke-linecap='round' stroke-linejoin='round'><path d='M8.6 9.6V7a1.8 1.8 0 0 1 1.8-1.8h3.2A1.8 1.8 0 0 1 15.4 7v2.6'/><path d='M5.8 9.6h12.4a2.2 2.2 0 0 1 2.2 2.2v6.8a2.2 2.2 0 0 1-2.2 2.2H5.8a2.2 2.2 0 0 1-2.2-2.2v-6.8a2.2 2.2 0 0 1 2.2-2.2Z'/><path d='M12 12.4a1.9 1.9 0 0 1 1.15 3.4v2.3a1.15 1.15 0 0 1-2.3 0v-2.3A1.9 1.9 0 0 1 12 12.4Z' fill='%234dd9b8' stroke='none'/><path d='M8.7 13.2 6.9 15.4l1.8 2.2'/><path d='M15.3 13.2l1.8 2.2-1.8 2.2'/></svg>">
