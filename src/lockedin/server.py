...
SCIENTIST_COMPATIBLE_CLIENT_VERSIONS = {SCIENTIST_CLIENT_VERSION, "2026.09.11.4", "2026.09.11.3", "2026.09.11.2"}
DEMO_ACCESS_MESSAGE = (
...
<link rel="icon" type="image/svg+xml" href="/brand/lockedin-lock.svg">
...
def build_app():
    ...
    def brand_asset(filename: str):
        ...
        if safe != filename or safe not in {"lockedin-lock.svg", "overleaf.svg", "slack.svg"}:
