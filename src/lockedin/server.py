...
<link rel="icon" href="data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%234dd9b8' stroke-width='1.9' stroke-linecap='round' stroke-linejoin='round'><path d='M8.8 11.2V7.4a3.2 3.2 0 0 1 6.4 0v3.8'/><path d='M5.9 11.2h12.2a1.5 1.5 0 0 1 1.5 1.5v6.6a1.5 1.5 0 0 1-1.5 1.5H5.9a1.5 1.5 0 0 1-1.5-1.5v-6.6a1.5 1.5 0 0 1 1.5-1.5Z'/><path d='M10.6 13.8 13.6 16l-3 2.2'/></svg>">
