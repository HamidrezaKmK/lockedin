...
# the agent follows the live formatting conventions instead of a hand-copied summary that drifts.
# Best-effort: if it fails, continue with an empty guide rather than blocking the session.
